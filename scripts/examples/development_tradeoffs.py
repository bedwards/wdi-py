...
for code in test_codes:
    test_df = wdi.sql.get_values(indicator_code=code, year=year)
...
print(f"Looking for indicator_y: {indicator_y}")
...
df_y = wdi.sql.get_values(indicator_code=indicator_y, year=year)
